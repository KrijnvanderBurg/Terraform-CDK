"""
Main module for the terraform_cdk application.
...
from terraform_cdk.file import FileHandlerFactory
from terraform_cdk.logger import setup_logger
from terraform_cdk.stacks.lake_house import LakeHouseStack, LakeHouseStackConfig
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="terraform_cdk")
    parser.add_argument(
        "--config-filepath",
        required=True,
        type=str,
