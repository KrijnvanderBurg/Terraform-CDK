...
The included DevContainer is setup with Python and CDKTF and has various automated tasks for code quality, dependency installs, running tests, and running Terraform synth.
